...
Thank you for your interest in contributing to Overseer agents dashboard! This guide explains how to collaborate effectively, whether you're a human contributor or an AI-assisted tool.
...
- Browse our [issue tracker](https://github.com/aytordev/overseer/issues)
...
2. **Clone Your Fork**
   ...
   ```bash
   git clone git@github.com:YOUR-USERNAME/overseer.git
   cd overseer
   ```
...
3. **Configure Remotes**
   ...
   ```bash
   git remote add upstream git@github.com:aytordev/overseer.git
   ```
...
1. Push your changes:
   ...
   ```
2. Open a [new pull request](https://github.com/aytordev/overseer/compare)
...
1. **Search First**
   ...
   - Search [existing issues](https://github.com/aytordev/overseer/issues)
   - Look through [discussions](https://github.com/aytordev/overseer/discussions)
...
💡 _Need help? [Open an issue](https://github.com/aytordev/overseer/issues/new/choose) or join our [discussions](https://github.com/aytordev/overseer/discussions) for support._
